...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform [transition-duration:var(--duration)] [transition-timing-function:var(--easing)] [transition-delay:var(--delay)] will-change-transform w-full h-full"
      ref={refElement}
      onPointerMove={(event) => {
