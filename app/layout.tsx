...
function Footer() {
  return (
    <footer className="w-full border-t border-neutral-800 bg-neutral-950/95 py-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4 text-neutral-400 text-sm mt-12">
      <div className="flex items-center gap-3">
        <span className="inline-block w-7 h-7 rounded bg-gradient-to-br from-blue-500 to-green-400 flex items-center justify-center shadow-md">
          <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="10" cy="10" r="8" fill="white"/><circle cx="10" cy="10" r="6" fill="#22d3ee"/></svg>
        </span>
  <span className="font-black text-white text-lg">50 Shades of Hue</span>
        <span className="text-neutral-500">© {new Date().getFullYear()}</span>
      </div>
      <div className="flex items-center gap-6">
        <a href="https://github.com/Arjun140205" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-1">
        ...
        <a href="https://x.com/Arjunbir_singhh" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-1">
  ...
  <a href="mailto:hello@50shadesofhue.com" className="hover:text-white transition-colors flex items-center gap-1">
          <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4h16v16H4V4zm0 0l8 8m8-8l-8 8"/></svg>
